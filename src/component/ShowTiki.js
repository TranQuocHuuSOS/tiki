...
//     await axios.get("http://127.0.0.1:8000/api/gets-product").then((res) => {
...
//     }
//     await axios
//       .post("http://localhost:8000/api/adds-product", {
//         name: $("#inputName").val(),
//         images: $("#inputImage").val().split("\\")[2],
//         price: $("#inputPrice").val(),
//         promotion: $("#inputPromotionPrice").val(),
...
//       await axios
//         .delete(`http://localhost:8000/api/deletes-product/${id}`, {})
//         .then((res) => {
...
//     await axios
//       .put(`http://localhost:8000/api/edits-product/${id}`, {
//         name: $("#editName").val(),
//         images: image,
//         price: $("#editPrice").val(),
//         promotion: $("#editPromotionPrice").val(),
...
//     $("#editPromotionPrice").val(product.promotion);
...
//     {
//       name: "Name",selector: "name",sortable: true,wrap: true,compact: true,
//     },
//     {
//       name: "Image",
//       cell: (row) => (
...
//     {
//       name: "Price",selector: "price",sortable: true,wrap: true,compact: true,
//     },
//     {
//       name: "Promotion",selector: "promotion",sortable: true,wrap: true,compact: true,
//     },
//     {
//       name: "Description",selector: "description",sortable: true,wrap: true,compact: true,
//     },
//     {
//       name: "Action",
//       selector: "id",
...
//         <div>
//           <button
//             data-tag="allowRowEvents"className="btn btn-sm btn-warning"style={{ width: "80px" }}onClick={() => {this.editProduct(row.id);}}
//             type="button"data-toggle="modal"data-target="#modelEditProduct"
//           >
//             Edit
//           </button>
//           <button
...
class ShowTiki extends Component {
  ...
  async componentDidMount() {
    await axios.get("http://localhost:8000/api/gets-product").then((res) => {
      this.setState(() => ({ products: res.data }));
    });
  }
  previewImage() {
  ...
  async editProduct(id) {
    ...
    $("#editType").val(product.promotion);
  }
